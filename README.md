...
| **Gewischt, nicht geladen** | Die vier Rubriken liegen als Bahnen nebeneinander; seitliches Wischen rastet auf die nächste ein. Der Name der aktuellen Rubrik schwebt als Glaskapsel darüber und bleibt beim Scrollen oben stehen. Alles Bedienbare — Kopfleiste, Rubrikname, Schreibfeld — liegt als Milchglas über dem Inhalt, der darunter durchzieht. Ohne eine Zeile JavaScript: `scroll-snap` ist die Geste, `#anker` derselbe Weg für Tastatur und Screenreader. |
